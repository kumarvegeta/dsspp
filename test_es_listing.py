...
for root, dirs, files in os.walk(r'./wiki_es'):
    for file in files:
...
with open("count_vectorizer_spanish.pkl", 'wb') as vectorizer_handle:
...
with open("vocabulary_spanish.pkl",'wb') as handle:
...
with open("tf_idf_matrix_spanish.pkl", 'wb') as tf_idf_matrix_handle:
